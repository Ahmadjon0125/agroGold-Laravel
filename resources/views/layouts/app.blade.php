...
<body>
    <header class="fixed z-50 top-0 w-full" id="mainHeader">
        <div>
            <div class="bg-white bottomShadow lg:shadowNone">
                <div class="container">
                    <div id="toggle" class="flex items-center py-[20px]">
                        <a href="/">
                            <img src="{{ asset('storage/img/logo.svg') }}" alt="site-logo"
            ...
            <nav class="{{ request()->is('/') ? '' : 'isPage' }}" style="--bg-image-url: url('{{ asset('../storage/img/heroBg.jpg') }}')"
 >
                <div class="container">
        ...
        <div class="mobile-nav" id="mobileNav">
            <div class="mobile-nav-content flex flex-col justify-between h-full">
                <div class="mobile-content mt-15 lg:mt-0">
                    ...
                    <a href=""
                        class="block lg:hidden py-[18px] bg-[#D24A43] text-white font-semibold text-[12px] uppercase rounded-[50px] text-center mb-[25px] border-2 border-[#D24A43] hover:bg-white hover:text-[#D24A43] transition-all duration-500 ease"> {{ __('app.write') }}</a>
                </div>
    ...
    <main>
        ...
        <!-- 8-section -->
        <section class="relative py-20 lg:py-32 bg-cover bg-center"
            style="
        ...
        ">
            ...
            <div class="container mx-auto relative z-10">
                <h2 class="text-[36px] md:text-[60px] font-bold text-white mb-10 md:mb-16 text-center lg:text-start">
                    Свяжитесь с нами
                </h2>
                        ...
                        <form class="space-y-6">
                            ...
                            <div>
                                <textarea rows="5" placeholder="Комментарий"
                                    class="w-full p-4 rounded-[20px] outline-none bg-opacity-10 border border-white border-opacity-30 text-white placeholder-white placeholder-opacity-70 transition duration-200 resize-y"></textarea>
                            </div>
