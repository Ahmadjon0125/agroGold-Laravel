        ...
        <div class="container">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                @foreach ($blogs as $blog)
                    <a href="{{ route('blogIn.page', [
                        'id' => $blog->id,
                        'slug' => $blog->{'slug_' . $locale},
                    ]) }}"
                        ...
                        <div class="relative h-[200px] md:h-[220px]">
                            <img src="{{ asset('storage/' . $blog->img) }}" alt="Yangilik 1"
                        ...
                        <div class="p-6">
                            ...
                            <p class="text-sm text-[#777] leading-relaxed">
                                {{ strip_tags(Str::limit($blog->{'text_' . $locale}, 150)) }}
                            </p>
                        </div>
                    </a>
                @endforeach
