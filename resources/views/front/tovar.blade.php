    ...
    <main>
      ...
      <section class="mt-[86px] lg:mt-[214px] mb-[35px] sm:mb-[60px] lg:mb-[91px]">
        <div class="container">
          ...
          >
            <a href="/" class="hover:text-[#77B75F] transition">Категории</a>
            <span class="bg-[#77B75F] w-[2px] h-[30px]"></span>
            <a href="/category.html" class="hover:text-[#77B75F]">Гербициды</a>
            <span class="bg-[#77B75F] w-[2px] h-[30px]"></span>
            <a class="text-[#77B75F]">Zellek Gold</a>
          </div>
          ...
          <div
            class="flex flex-col md:flex-row gap-8 lg:gap-12 items-center mb-[25px] sm:mb-[45px] lg:mb-[67px]"
          >
            <div
              class="flex justify-center items-center py-[68px] bg-[#F4F4F4] rounded-[20px] flex-shrink-0 max-w-[500px]"
            >
              <img
                src="./img/prod1.png"
                alt="ZELLEK GOLD Gerbitsid"
                class="max-w-full lg:h-[365px] object-contain"
              />
            </div>

            <div
              class="space-y-2 pt-4 md:flex-grow md:w-full text-center md:text-start"
            >
              <p class="text-[#939393] text-[16px] font-[500]">
                Действующее вещество:
              </p>
              <h3
                class="text-[#474747] font-[700] text-[20px] mt-[10px] mb-[16px] leading-none"
              >
                ГАЛОКСИФОП R МЕТИЛ 104 Г
              </h3>
              <p class="text-[#939393] text-[16px] font-[500]">
                Лекарственная форма:
              </p>
              ...
              <p class="text-[#939393] text-[16px] font-[500]">Упаковка:</p>
              <h3
                class="text-[#474747] font-[700] text-[20px] mt-[10px] mb-[16px] leading-none"
              >
                1Л, БЛ.
              ...
              <button
                class="bg-[#77B75F] text-white font-semibold py-3 px-8 border-2 cursor-pointer rounded-full hover:bg-white hover:text-[#77B75F] transition duration-300 mt-[20px]"
              >
                ОСТАВИТЬ ЗАЯВКУ
              </button>
            </div>
          ...
          <h3 class="text-[#474747] lg:text-[40px] sm:text-[30px] text-[20px] font-[800] mb-[15px] lg:mb-[22px]  text-center md:text-start">Использование:</h3>
          <p class="text-[#474747] text-[18px] font-[500] mb-[20px] lg:mb-[38px] text-center md:text-start">
          ...
          <h3 class="text-[#474747] lg:text-[40px] sm:text-[30px] text-[20px] font-[800] mb-[15px] lg:mb-[22px] text-center md:text-start">Преимущества:</h3>
          <p class="text-[#474747] text-[18px] font-[500] text-center md:text-start">
