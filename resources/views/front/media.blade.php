    ...
    <main>
      ...
      <section class="mt-[86px] lg:mt-[214px] mb-[35px] sm:mb-[60px] lg:mb-[91px]">
        <div class="container">
          <!-- Breadcrumb -->
          <div
            class="text-[16px] sm:text-[18px] lg:text-[22px] text-black breadcrumb gap-3 pt-[50px] mb-[33px]"
          >
...
<div class=" mx-auto  py-8">
  ...
  <div id="tab-content">
    <div id="photo-gallery" class="tab-pane">
      <h2  class="text-[25px] sm:text-[40px] lg:text-[60px] font-extrabold text-[#474747] mb-[22px] text-center lg:text-start leading-none">
        Фотогалерея
      </h2>
       <div
            class="w-[60px] h-[8px] bg-[#77B75F] rounded-[20px] mb-[50px] mx-auto lg:mr-auto lg:ml-0"
          ></div>
            ...
            <div
              class="w-full  relative rounded-3xl overflow-hidden shadow-xl order-2 lg:order-1"
            >
              <div
                id="gallery-main"
                class="splide h-[350px] sm:h-[450px] lg:h-[500px]"
              >
                <div class="splide__track h-full">
                  <ul class="splide__list">
                    <li class="splide__slide relative">
                      <a
                        href="./img/mainThumb.jpg"
                        data-fancybox="gallery"
                        data-caption="LOREM IPSUM DOLOR SIT AMET"
                        class="block w-full h-full cursor-pointer"
                      >
                        <img
                          src="./img/categoryBg.jpg"
                          alt="Main Photo 1"
...
<div class=" mx-auto ">
  ...
  <div class="mb-6 rounded-[20px] overflow-hidden ">
    <a 
      href="URL_TO_LARGE_VIDEO_DEFAULT" 
      id="main-media-link" 
      data-fancybox="main-media" 
      class="block relative w-full pt-[56.25%]  h-[350px] lg:h-[660px]" 
    >
      
      <img
        src="/img/categoryBg.jpg"
        alt="Asosiy media posteri"
        class="absolute inset-0 w-full h-full object-cover"
        id="main-media-element" 
      />
      
      <div class="absolute inset-0 flex items-center justify-center bg-black/30 transition-opacity hover:opacity-100">
       <img src="./img/play.png" alt="">
      </div>
      
      <div class="absolute bottom-0 left-0 p-8 text-white bg-gradient-to-t from-black/70 to-transparent w-full">
        <h2 class="text-3xl font-bold uppercase mb-2" id="main-title">LOREM IPSUM DOLOR SIT AMET (DEFAULT)</h2>
        <p class="text-sm" id="main-description">Duis aute irure dolor in reprehenderit in voluptate velit.</p>
      </div>
    </a>
  </div>
...
<a 
  href="#" 
  class="media-thumbnail group block rounded-xl overflow-hidden  hover:shadow-lg transition-shadow duration-300 cursor-pointer"
  data-media-url="https://www.youtube.com/watch?v=zhkvXc7wJZE&list=PL6tf8fRbavl0RUNYSOMfl09lXCs5EPmj5" 
  data-title="Yangi Sarlavha 1" 
  data-description="Video 1 haqida qisqacha ma'lumot."
  data-poster="/img/categoryBg.jpg"
>
  
  <div class="relative  sm:h-[200px] lg:h-[260px]">
    <div class="hidden group-hover:block absolute inset-0 bg-[#77B75F]/50 transition-opacity">
    </div>

    <div class="hidden group-hover:flex absolute inset-0 items-center justify-center z-10">
       <img src="./img/play.png" alt="" class="w-12 h-12"> </div>

    <img src="/img/categoryBg.jpg" alt="Kichik rasm 1" class="w-full h-full object-cover"/>
  </div>
  
  <div class=" text-center bg-[#F4F4F4] pb-[15px] lg:pb-[31px] pt-[15px] lg:pt-[25px]">
    <h3 class="text-[16px] lg:text-[20px] leading-none font-[700] uppercase text-[#474747] group-hover:text-[#77B75F]">LOREM IPSUM DOLOR SIT AMET</h3>
  </div>
</a>
...
<a 
  ...
  class="media-thumbnail group block rounded-xl overflow-hidden  hover:shadow-lg transition-shadow duration-300 cursor-pointer"
  data-media-url="https://www.youtube.com/watch?v=zhkvXc7wJZE&list=PL6tf8fRbavl0RUNYSOMfl09lXCs5EPmj5" 
  data-title="Yangi Sarlavha 2" 
  data-description="Video 2 haqida qisqacha ma'lumot."
  data-poster="/img/categoryBg.jpg"
>
...
<a 
  ...
  class="media-thumbnail group block rounded-xl overflow-hidden  hover:shadow-lg transition-shadow duration-300 cursor-pointer"
  data-media-url="https://www.youtube.com/watch?v=zhkvXc7wJZE&list=PL6tf8fRbavl0RUNYSOMfl09lXCs5EPmj5" 
  data-title="Yangi Sarlavha 3" 
  data-description="Video 3 haqida qisqacha ma'lumot."
  data-poster="/img/categoryBg.jpg"
>
