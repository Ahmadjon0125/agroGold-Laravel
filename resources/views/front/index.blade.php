...
@section('content')
      ...
      <!-- 1-section -->
      <section
        class="hero relative h-[400px] sm:h-[500px] lg:h-[700px] mt-[106px]"
      >
        <div class="swiper">
      ...
      @foreach ( $sliders as $slider )
            ...
            >
              ...
              <div class="container">
                <div
                  class="slide-content text-white z-2 relative text-center lg:text-start"
                >
                  <h2
                 ...
                 {{ $slider -> {'title_' . $locale} }}
                  ...
                  <span
                    class="bg-[#77B75F] w-[110px] h-[6px] lg:h-[12px] inline-block rounded-[10px] mb-[10px] lg:mb-[19px]"
                  ></span>
                  <p
         ...
         @endforeach
          ...
          <div class="container">
            <div
              class="swiper-pagination justify-center lg:justify-start z-5"
            ></div>
          </div>
        </div>
      </section>
      ...
      <section class="relative lg:-top-40 z-2 py-[20px]">
        <div class="container">
          <div
            class="flex flex-col lg:flex-row gap-10 lg:gap-[80px] lg:items-end"
          >
            <div
      ...
      <section class="relative py-8 lg:py-20 bg-[#F4F4F4] overflow-hidden">
        ...
        <div class="container relative z-10">
          <div
            class="flex flex-col lg:flex-row lg:justify-between items-center mb-12"
          >
            <h2
              class="text-[32px] md:text-[48px] font-bold text-white mb-[20px] text-center lg:mb-0"
            >
              Категории удобрений
            </h2>
            <a
          ...
          <div
            class="grid grid-cols-2 lg:grid-cols-3 gap-[10px] sm:gap-[20px] lg:gap-[30px] categGrid"
          >
      ...
      <section class="py-8 lg:py-20 bg-white">
        <div class="container">
          <div
            class="flex flex-col lg:flex-row lg:justify-between justify-center items-center mb-12"
          >
            <h2
              class="text-[32px] md:text-[48px] font-bold text-[#333] mb-3 lg:mb-0 text-center leading-none"
            >
              Лучшие продукты
            </h2>
            <a
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            >
              ...
              <h3
                class="text-[20px] font-bold text-[#474747] mb-2 text-center uupercase"
              >
                ZELLEK GOLD
              </h3>
      ...
      <section class="relative py-8 lg:py-20 overflow-hidden">
        ...
        <div class="container relative z-10">
          <h2
            class="text-[32px] md:text-[48px] font-bold text-white mb-12 text-center lg:text-start"
          >
            Страны-партнёры
          </h2>

          <div
            class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mx-auto"
          >
            <div
      ...
      <section class="py-8 lg:py-20 bg-white">
        <div class="container mx-auto px-4">
          <h2
            class="text-[32px] md:text-[60px] font-[800] text-[#474747] mb-[20px] sm:mb-[32px] lg:mb-[52px]"
          >
            Фотогалерея
          </h2>
          ...
          <div class="flex flex-col lg:flex-row gap-6">
            <div
              class="w-full lg:w-2/3 relative rounded-3xl overflow-hidden shadow-xl order-2 lg:order-1"
            >
              <div
                id="gallery-main"
      ...
      <section class="py-20 bg-white">
        <div class="container mx-auto px-4">
          ...
          >
            ...
            <a
              href="#"
              class="px-6 py-3 border-2 border-[#E33B44] text-[#E33B44] rounded-full hover:bg-[#E33B44] hover:text-white transition-colors duration-300 text-[14px] font-semibold"
            >
              ВСЕ НОВОСТИ
            </a>
          </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <a href=""
              class="bg-[#F8F8F8] rounded-[20px] overflow-hidden group hover:shadow-md hover:scale-[1.03] hover:-translate-y-1 transition-all duration-400 ease cursor-pointer"
            >
