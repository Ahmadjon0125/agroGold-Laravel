      ...
      <section class="mt-[86px] lg:mt-[214px]">
        <div class="container">
          ...
          <div class="flex flex-col lg:flex-row gap-8 lg:gap-16 items-start">
            <div
              class="bg-white rounded-[20px] w-full md:w-1/2 xl:w-[45%] mx-auto"
            >
              <h3
            ...
            <div class="w-full lg:w-1/2 xl:w-[55%] pt-10 lg:pt-0">
              ...
              <div
                class="w-[60px] h-[8px] bg-[#77B75F] rounded-[20px] mb-[30px] mx-auto lg:mr-auto lg:ml-0"
              ></div>
              <form class="space-y-6">
                ...
                <div>
                  <textarea
                    ...
                    class="w-full pl-[30px] py-[18px] placeholder-[#474747] placeholder-font-medium rounded-[20px] outline-none bg-[#F4F4F4] transition duration-200 resize-y"
                  ></textarea>
                </div>
